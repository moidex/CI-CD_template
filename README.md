...
Если нам нужно добавить много ключей, то мы добавляем много ключей в Lockbox, а в yml файле мы добаляем несколько строк как мы указали выше, но важно чтобы у каждой не последней строки в конце было ` \` (пробел и обратный слэш), иначе не взлетит
