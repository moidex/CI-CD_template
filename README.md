...
Сеть в клауде это сущность которая позволит вам настраивать вам правило подключения и настраивать роутинг
Шаг 1. Создание VPC
...
Итак вы написали код. Но что делать с чуствительными ключами которые вам не хотелось бы чтобы попали в чужие лапки?
...
А очень легко в ci.yml (файл пайплайна) мы на 96 строке начинаем указыать наши секреты
Пример как это может выглядеть на 97 строке
Разберем по порядку
